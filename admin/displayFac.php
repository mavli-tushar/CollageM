            ...
            ?>
                    <div class="box">
                        ...
                        <div class="my-flex-btn">
                            ...
                            <a href="displayFac.php?delete=<?= $fetch_faculty['id']; ?>&faculty_id=<?= $fetch_faculty['id'] ?>" class="delete-btn" onclick="return confirm('delete this faculty details?');"><i class="fa fa-trash"></i>Delete</a>
                        </div>
                    </div>
            <?php
                }
