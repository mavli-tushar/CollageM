...
<body>
    ...
    <section class="form-container">
        ...
        <form action="" method="post" enctype="multipart/form-data" onsubmit="return validatePhoneNumber();">
            ...
            <input type="text" name="email" placeholder="Email ID" value="<?= $result_faculty_id['email']; ?>" required
                class="box" />
            <input type="text" id="phone_no" name="phone_no" placeholder="Phone Number" value="<?= $result_faculty_id['phone_no']; ?>"
                required class="box" />
            ...
            <div class="my-flex-btn">
                ...
                <a href="displayFac.php" class="delete-btnf">go back</a>
            </div>
        </form>
